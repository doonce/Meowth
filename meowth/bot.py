...
class MeowthBot(commands.AutoShardedBot):
    ...
    def __init__(self, **kwargs):
        ...
        self.report_dicts = ['questreport_dict', 'pokealarm_dict', 'trade_dict', 'nest_dict', 'wildreport_dict', 'lure_dict', 'pvp_dict', 'invasion_dict', 'pokehuntr_dict']
    ...
    async def on_ready(self):
        ...
        for guild in list(self.guilds):
            ...
            try:
                ...
                del self.guild_dict[guild.id]['configure_dict']['scanners']['wildfilter']
            except:
                pass
            try:
